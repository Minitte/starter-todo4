...
class Mtce extends Application
{
    ...
    private function showit()
    {
        ...
        $fields = array(
            ...
            'fsize'      => form_label('Size') . form_dropdown('size', $this->app->size(), $task->size), // drop
            'fgroup'     => form_label('Group') . form_dropdown('group', $this->app->group(), $task->group), // drop
            'fstatus'      => form_label('Status') . form_dropdown('status', $this->app->status(), $task->status), // drop
